...
$i=$id['MAX(movieId)']+1;
mysqli_query($con,"INSERT INTO movies VALUES ($i,'$name','$geners','$des',$year,1,'$urt')");
mysqli_query($con,"INSERT INTO ratings VALUES (0,$i,$rate,0,'$com')");
mysqli_close($con);
header("location:Addmovie-A.php?success=Movie added");
}

else{
mysqli_close($con);
header("location:Addmovie-A.php?error=All feild required");
}
}
if(!empty($_POST['reset'])){
	header("location:Addmovie-A.php?success=Canceled");
}
}
?>
<!DOCTYPE html>
		...
		<div id="site-content">
			...
			<div class="main-navigation">
						...
						<ul class="menu">
							...
							<li class="menu-item current-menu-item"><a href="Addmovie-A.php">Add movie</a></li>
				...
				<div class="container">
					...
					<input type="text" placeholder="e.g https://static.dw.com/image/18686404_101.jpg" style="background-color: #131a20;color: aliceblue;" name ="poster" >
                           <br><br>
							...
							<input name="submit" type ="submit" class="btn btn-info" value="Add"></input>
